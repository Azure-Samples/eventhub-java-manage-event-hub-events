...
public class ManageEventHubEvents {
    ...
    public static boolean runSample(AzureResourceManager azureResourceManager) {
        ...
        final String rgName = Utils.randomResourceName(azureResourceManager, "rgEvHb", 14);
        final String namespaceName = Utils.randomResourceName(azureResourceManager, "ns", 14);
